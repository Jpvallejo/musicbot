...
var _this = this;
var acceptedMethods = require("../src/configs/config.json").acceptedMethods;
var Discord = require("discord.js");
require("dotenv").config();
var PlayService = require("./services/playService")["default"];
var Distube = require("distube");
var prefix = process.env.PREFIX;
var token = process.env.TOKEN;
var client = new Discord.Client();
var distube = new Distube(client, {
    searchSongs: false,
