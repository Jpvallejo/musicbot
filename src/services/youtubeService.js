...
var YoutubeService = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log(query);
                        return [4 /*yield*/, searcher.search(query)];
    ...
    YoutubeService.getSongInfo = function (songString) {
        return __awaiter(this, void 0, void 0, function () {
            var songUrl, songInfo;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        songUrl = songString;
                        if (!(!songString.startsWith("http") && !songString.startsWith("www"))) return [3 /*break*/, 2];
                        return [4 /*yield*/, YoutubeService.search(songString)];
                    case 1:
                        songUrl = (_a.sent()).first.url;
                        _a.label = 2;
                    case 2: return [4 /*yield*/, ytdl.getInfo(songUrl)];
                    case 3:
                        songInfo = _a.sent();
                        return [2 /*return*/, {
